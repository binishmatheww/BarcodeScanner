...
import com.binishmatheww.barcode.scanner.camera.CameraReticleAnimator
import com.binishmatheww.barcode.scanner.camera.FrameProcessorBase
    ...
    override fun onSuccess(
        ...
        if (barcodeInCenter == null) {
            ...
            if (sizeProgress < 1) {
                ...
                workflowModel.setWorkflowState(WorkflowState.UNCLEAR)
            } else {
                ...
                if (Utils.shouldDelayLoadingBarcodeResult(graphicOverlay.context)) {
                    ...
                    workflowModel.setWorkflowState(WorkflowState.PROCESSING)
                } else {
        ...
        return ValueAnimator.ofFloat(0f, endProgress).apply {
            ...
            addUpdateListener {
                if ((animatedValue as Float).compareTo(endProgress) >= 0) {
                    graphicOverlay.clear()
                    workflowModel.setWorkflowState(WorkflowState.PROCESSED)
