...
import com.binishmatheww.barcode.scanner.R
import com.binishmatheww.barcode.scanner.barcode.Utils
...
class CameraSourcePreview(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        val previewSizeRatio = getPreviewSizeRatio(cameraPreviewSize) ?: layoutWidth.toFloat() / layoutHeight.toFloat()
    ...
    private fun getPreviewSizeRatio( cameraPreviewSize : Size? ) : Float? {

        cameraPreviewSize?.let { size ->
            /*return*/ if (Utils.isPortraitMode(context)) {
