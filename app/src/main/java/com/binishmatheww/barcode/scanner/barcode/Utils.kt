...
package com.binishmatheww.barcode.scanner.barcode
...
import com.binishmatheww.barcode.scanner.camera.CameraSizePair
...
object Utils {
    ...
    const val pref_key_enable_barcode_size_check = "pref_key_enable_barcode_size_check"
    const val pref_key_delay_loading_barcode_result = "pref_key_delay_loading_barcode_result"
    const val pref_key_rear_camera_preview_size = "pref_key_rear_camera_preview_size"
    const val pref_key_rear_camera_picture_size = "pref_key_rear_camera_picture_size"

    const val pref_key_minimum_barcode_width = "pref_key_minimum_barcode_width"
    const val pref_key_barcode_reticle_width = "pref_key_barcode_reticle_width"
    const val pref_key_barcode_reticle_height = "pref_key_barcode_reticle_height"
    ...
    fun getBarcodeReticleBox(overlay: GraphicOverlay): RectF {
        ...
        val boxHeight = overlayHeight * getIntPref(context, pref_key_barcode_reticle_height, 40) / 100
    ...
    fun getUserSpecifiedPreviewSize(context: Context): CameraSizePair? {
        return try {
            val sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context)
            CameraSizePair(
                Size.parseSize(sharedPreferences.getString(pref_key_rear_camera_preview_size, "") ?: ""),
                Size.parseSize(sharedPreferences.getString(pref_key_rear_camera_picture_size, "") ?: "")
            )
        } catch (e: Exception) {
            null
        }
